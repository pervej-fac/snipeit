...
Route::group(
    ...
    function () {
        ...
        Route::post(
            'bulkapprove',
            [
                'as'   => 'hardware/bulkapprove',
                'uses' => 'Assets\BulkAssetsController@approve'
            ]
        );
        Route::post(
            'bulkpurchase',
            [
                'as'   => 'hardware/bulkpurchase',
                'uses' => 'Assets\BulkAssetsController@purchase'
            ]
        );
        Route::post(
            'bulkassign',
            [
                'as'   => 'hardware/bulkassign',
                'uses' => 'Assets\BulkAssetsController@assign'
            ]
        );
        Route::post(
            'bulksave',
