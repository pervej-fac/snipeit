          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview{{ (Request::is('hardware*') ? ' active' : '') }}">
                ...
                <ul class="treeview-menu">
                  ...
                  <li{!! (Request::query('status') == 'Assign' ? ' class="active"' : '') !!}>
                    <a href="{{ url('hardware?status=Assign') }}">
                  ...
                  <li{!! (Request::query('status') == 'Procurement' ? ' class="active"' : '') !!}>
                    <a href="{{ url('hardware?status=Procurement') }}">
                        <i class="fa fa-circle-o text-green"></i>
                        {{-- {{ trans('general.all') }} --}}
                        Ready to Purchase
                        {{-- ({{ (isset($total_rtd_sidebar)) ? $total_rtd_sidebar : '' }}) --}}
            ...
            @can('backend.interact')
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        @can('view', \App\Models\Process::class)
                            <li>
                                <a href="{{ route('processes.index') }}" {{ (Request::is('/processes') ? ' class="active"' : '') }}>
                                    {{ trans('general.process') }}
                                </a>
                            </li>
                        @endcan
