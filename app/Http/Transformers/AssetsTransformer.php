...
class AssetsTransformer
{
    ...
    public function transformAsset(Asset $asset)
    {
        $array = [
            'id' => (int) $asset->id,
            'assign_level' => (int) $asset->assign_level,
            'level' => (int) $asset->level,
            // 'process' => (int) $asset->process_id,
            'process' => ($asset->process) ? [
                'id' => (int) $asset->process->id,
                'name'=> e($asset->process->name)
            ]  : null,
            'name' => e($asset->name),
        ...
        $permissions_array['available_actions'] = [
            ...
            'restore' => false,
            // 'approve' => (bool) Gate::allows('approve', Asset::class),
