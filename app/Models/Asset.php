...
class Asset extends Depreciable
{
   ...
   */
     ...
     * @return boolean
     */
    public function checkOut($target, $admin = null, $assign_level = null, $checkout_at = null, $expected_checkin = null, $note = null, $name = null, $location = null)
    {
        if (!$target) {
            return false;
        }
        ...
        $this->assign_level = $assign_level;
        if ($this->save()) {
            if (is_integer($admin)){
    ...
    {
        return $this->belongsTo('\App\Models\ProcessDetail', 'level','id');
    }
